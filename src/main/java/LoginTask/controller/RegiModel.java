...
public class RegiModel {
	...
	public RegiModel(String id, String pwd, String name, String birth_year, String birth_mon, String birth_day,
	...
	public String toString() {
		return "RegiModel [id=" + id + ", pwd=" + pwd + ", name=" + name + ", birth_year=" + birth_year + ", birth_mon="
